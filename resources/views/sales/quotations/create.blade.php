@extends('layouts.app')
@section('title', 'New Sales Quotation Entry')
@section('content')
<div class="mb-8">
...
@if($addedQU)
    <div class="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded mb-4 text-center">
        Quotation # {{ $addedQU }} has been entered.
    </div>
    <div class="text-center mb-4">
        <a href="{{ route('sales.quotations.create', ['NewQuotation' => 1]) }}" class="text-indigo-600 hover:text-indigo-900 underline">Enter a New Quotation</a>
    </div>
@else

<form method="POST" action="{{ route('sales.quotations.create') }}">
@csrf
            ...
            <div class="mt-4 bg-gray-50 rounded-lg border border-gray-200 p-4">
                <div class="flex items-center justify-end gap-4">
                    <div class="flex items-center gap-2">
                        ...
                        <input type="text" name="freight_cost" value="{{ number_format($cart['freight_cost'], 4) }}" class="w-24 border border-gray-300 rounded-md px-3 py-1.5 text-right text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                ...
                <div class="flex items-center justify-end gap-6 mt-2">
                    @php $subtotal = $total + $cart['freight_cost']; @endphp
...
<div class="flex justify-center gap-4 mt-6">
    <a href="{{ route('sales.quotations.index') }}" class="px-6 py-2.5 bg-white text-gray-700 font-medium rounded-md hover:bg-gray-100 transition border border-gray-300 shadow-sm"><i class="fas fa-times mr-2"></i>Cancel</a>
