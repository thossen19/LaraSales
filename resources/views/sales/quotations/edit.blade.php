@extends('layouts.app')
@section('title', 'Edit Sales Quotation - Sales ERP')
@section('content')
<div class="mb-8">
    <h2 class="text-2xl font-bold text-gray-900">Edit Sales Quotation #{{ $quotation->quotation_number }}</h2>
</div>
...
<form method="POST" action="{{ route('sales.quotations.edit', $quotation) }}">
@csrf
