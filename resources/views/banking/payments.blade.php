@extends('layouts.app')
@section('title', 'Bank Account Payment Entry - Sales ERP')
@section('content')
<div class="mb-8">
    <h2 class="text-2xl font-bold text-gray-900">Bank Account Payment Entry</h2>
</div>
...
<form method="POST" action="{{ route('banking.payments') }}">
@csrf
<div id="pmt_header">
...
<td class="p-4 align-top w-1/3">
    <table class="w-full">
        <tr>
            <td class="py-2 pr-3 text-sm font-medium text-gray-700 whitespace-nowrap">Pay To:</td>
            <td class="py-2">
        ...
        @elseif($payType == 'misc')
        <tr>
            <td class="py-2 pr-3 text-sm font-medium text-gray-700 whitespace-nowrap">To the Order of:</td>
            <td class="py-2">
...
<div class="bg-white shadow rounded-lg p-4 mb-6">
    <h3 class="text-lg font-medium text-gray-800 mb-3">Payment Items</h3>
    <table class="w-full border-collapse" id="items_table">
        ...
        <tbody class="divide-y divide-gray-200">
            ...
            @php
                ...
                $colspan = 1; // Account Code cell
                $colspan += 1; // Description cell
            ...
            @if($isEditing)
                <tr class="bg-yellow-50">
                    <td colspan="{{ $colspan }}" class="px-3 py-2">
                        <input type="hidden" name="ClearEdit" value="1">
            ...
            @if(count($cart['gl_items'] ?? []) > 0)
                @php
                    $totalColspan = $colspan - 2; // exclude Amount column
...
<div class="text-center space-x-4">
    ...
    <button type="submit" name="Process" value="1" class="px-6 py-2 bg-indigo-600 text-white font-medium rounded-md hover:bg-indigo-700 transition">Process Payment</button>
</div>
