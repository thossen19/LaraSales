@extends('layouts.app')
@section('title', $outstanding_only ? 'Search Outstanding Dimensions - Sales ERP' : 'Search Dimensions - Sales ERP')
@section('content')
<div class="mb-8">
    <h2 class="text-2xl font-bold text-gray-900">{{ $outstanding_only ? 'Search Outstanding Dimensions' : 'Search Dimensions' }}</h2>
</div>

<form method="POST" action="{{ route('dimensions.outstanding', ['outstanding_only' => $outstanding_only]) }}">
@csrf
<table class="mb-4">
    <tr>
    ...
    <div class="overflow-x-auto">
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                @empty
                    <tr>
                        <td colspan="{{ 8 - ($outstanding_only ? 1 : 0) }}" class="px-3 py-8 text-center text-gray-500">No dimensions found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
