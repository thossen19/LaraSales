            ...
            <div class="container mx-auto px-6 py-8">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('login') }}" class="px-4 py-2 bg-white text-blue-700 rounded-lg hover:bg-blue-50 transition font-medium text-sm">
                            <i class="fas fa-sign-in-alt mr-1"></i>Login
                        </a>
                        <a href="{{ route('register') }}" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-400 transition font-medium text-sm">
