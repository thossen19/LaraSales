<?php $__env->startSection('title', 'Edit Sales Quotation - Sales ERP'); ?>
<?php $__env->startSection('content'); ?>
<div class="mb-8">
    <h2 class="text-2xl font-bold text-gray-900">Edit Sales Quotation #<?php echo e($quotation->quotation_number); ?></h2>
</div>
...
<form method="POST" action="<?php echo e(route('sales.quotations.edit', $quotation)); ?>">
<?php echo csrf_field(); ?>

<div class="bg-white shadow rounded-lg overflow-hidden mb-6">
    <div class="px-6 py-4 bg-gradient-to-r from-indigo-600 to-indigo-700">
        <h3 class="text-lg font-semibold text-white"><i class="fas fa-file-invoice mr-2"></i>Quotation Header</h3>
    </div>
    <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="ref" value="<?php echo e(old('ref', $cart['reference'])); ?>" class="mt-1 w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition">
                </div>
            </div>
            <div>
                <?php if($customerInfo): ?>
                ...
                <div class="mb-4">
                    ...
                    <select name="payment" class="mt-1 w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition">
                        <option value="">-- Select --</option>
...
<div class="bg-white shadow rounded-lg overflow-hidden mb-6">
    <div class="px-6 py-4 bg-gradient-to-r from-indigo-600 to-indigo-700">
        <h3 class="text-lg font-semibold text-white"><i class="fas fa-shopping-cart mr-2"></i>Sales Quotation Items</h3>
    </div>
    <div class="p-6">
        <div id="items_table">
            ...
            <div class="mt-4 bg-gray-50 rounded-lg border border-gray-200 p-4">
                <div class="flex items-center justify-end gap-4">
                    <div class="flex items-center gap-2">
                        ...
                        <input type="text" name="freight_cost" value="<?php echo e(number_format($cart['freight_cost'] ?? 0, 4)); ?>" class="w-24 border border-gray-300 rounded-md px-3 py-1.5 text-right text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
...
<div class="bg-white shadow rounded-lg overflow-hidden mb-6">
    <div class="px-6 py-4 bg-gradient-to-r from-indigo-600 to-indigo-700">
        <h3 class="text-lg font-semibold text-white"><i class="fas fa-truck mr-2"></i>Quotation Delivery Details</h3>
    </div>
    <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                <div class="mb-4">
                    ...
                    <select name="Location" class="mt-1 w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition">
                        <option value="">-- Select --</option>
...
<div class="flex justify-center gap-4 mt-6">
    <a href="<?php echo e(route('sales.quotations.index')); ?>" class="px-6 py-2.5 bg-white text-gray-700 font-medium rounded-md hover:bg-gray-100 transition border border-gray-300 shadow-sm"><i class="fas fa-times mr-2"></i>Cancel</a>
    <button type="submit" name="ProcessOrder" value="1" class="px-8 py-2.5 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white font-medium rounded-md hover:from-indigo-700 hover:to-indigo-800 transition shadow-sm"><i class="fas fa-check mr-2"></i>Update Quotation</button>
</div>
</form>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lupu\Desktop\laravel\fa-saas\resources\views/sales/quotations/edit.blade.php ENDPATH**/ ?>