            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                    ...
                    <div id="userMenu" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50">
                        ...
                        <form method="POST" action="<?php echo e(route('logout')); ?>" onsubmit="handleLogout(event)">
...
<?php /**PATH C:\Users\Lupu\Desktop\laravel\fa-saas\resources\views/components/header.blade.php ENDPATH**/ ?>