<?php $__env->startSection('title', 'Direct Delivery Entry - Sales ERP'); ?>
...
<?php if($addedID): ?>
    <div class="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded mb-4 text-center">
        Delivery # <?php echo e($addedID); ?> has been entered.
    </div>
    <div class="text-center mb-4">
        <a href="<?php echo e(route('sales.delivery.direct', ['NewDelivery' => 'Yes'])); ?>" class="text-indigo-600 hover:text-indigo-900 underline">Enter a New Delivery</a>
    </div>
<?php else: ?>

<form method="POST" action="<?php echo e(route('sales.delivery.direct')); ?>">
<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lupu\Desktop\laravel\fa-saas\resources\views/sales/delivery/direct.blade.php ENDPATH**/ ?>