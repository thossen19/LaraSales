...
<body>
    <div class="header">
        ...
        <p>Quotation #: <?php echo e($quotation->quotation_number); ?></p>
        <p>Date: <?php echo e($quotation->quotation_date ? date('d/m/Y', strtotime($quotation->quotation_date)) : ''); ?></p>
        <p>Valid Until: <?php echo e($quotation->expiry_date ? date('d/m/Y', strtotime($quotation->expiry_date)) : ''); ?></p>
        <p>Status: <?php echo e(ucfirst($quotation->status ?? 'draft')); ?></p>
    </div>

    <table class="details">
        <tr>
            <td class="label">Customer:</td>
            <td><?php echo e($quotation->customer->name ?? 'N/A'); ?></td>
            <td class="label">Reference:</td>
            <td><?php echo e($quotation->reference ?? '-'); ?></td>
        </tr>
        <tr>
            <td class="label">Sales Person:</td>
            <td><?php echo e($quotation->salesPerson->name ?? 'N/A'); ?></td>
            <td class="label">Sales Type:</td>
            <td><?php echo e($quotation->salesType->type_name ?? 'N/A'); ?></td>
        </tr>
        <?php if($quotation->deliver_to): ?>
        <tr>
            <td class="label">Deliver To:</td>
            <td colspan="3"><?php echo e($quotation->deliver_to); ?></td>
        </tr>
        <?php endif; ?>
        <?php if($quotation->delivery_address): ?>
        <tr>
            <td class="label">Address:</td>
            <td colspan="3"><?php echo e($quotation->delivery_address); ?></td>
        </tr>
        <?php endif; ?>
        <?php if($quotation->phone): ?>
        <tr>
            <td class="label">Phone:</td>
            <td colspan="3"><?php echo e($quotation->phone); ?></td>
        </tr>
        <?php endif; ?>
    </table>
    ...
    <table class="items">
        ...
        <tbody>
            <?php $i = 1; $subtotal = 0; ?>
            <?php $__currentLoopData = $quotation->lineItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <table class="totals">
        ...
        <tr>
            ...
            <td class="value">(<?php echo e(number_format($quotation->discount_amount, 2)); ?>)</td>
        </tr>
        <?php endif; ?>
        <?php if($quotation->freight_cost > 0): ?>
        <tr>
            <td class="label">Shipping:</td>
            <td class="value"><?php echo e(number_format($quotation->freight_cost, 2)); ?></td>
        </tr>
        <?php endif; ?>
        ...
        <tr class="grand">
            ...
            <td class="value"><?php echo e(number_format($quotation->total_amount, 2)); ?></td>
        </tr>
    </table>
    ...
    <div style="margin-top: 30px;">
        <strong>Notes:</strong>
        <p style="margin-top: 5px;"><?php echo e($quotation->customer_notes); ?></p>
    </div>
    <?php endif; ?>

    <div class="footer">
        Quotation #<?php echo e($quotation->quotation_number); ?> &mdash; Generated by FA-SAAS
    </div>
</body>
</html>
<?php /**PATH C:\Users\Lupu\Desktop\laravel\fa-saas\resources\views/sales/quotations/print.blade.php ENDPATH**/ ?>