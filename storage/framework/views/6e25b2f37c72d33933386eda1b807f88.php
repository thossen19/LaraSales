<?php $__env->startSection('title', 'New Sales Quotation Entry'); ?>
<?php $__env->startSection('content'); ?>
<div class="mb-8">
    <h2 class="text-2xl font-bold text-gray-900">New Sales Quotation Entry</h2>
</div>
...
<?php if($addedQU): ?>
    <div class="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded mb-4 text-center">
        Quotation # <?php echo e($addedQU); ?> has been entered.
    </div>
    <div class="text-center mb-4">
        <a href="<?php echo e(route('sales.quotations.create', ['NewQuotation' => 1])); ?>" class="text-indigo-600 hover:text-indigo-900 underline">Enter a New Quotation</a>
    </div>
<?php else: ?>

<form method="POST" action="<?php echo e(route('sales.quotations.create')); ?>">
<?php echo csrf_field(); ?>
        ...
        <div id="items_table">
            ...
            <div class="mt-4 bg-gray-50 rounded-lg border border-gray-200 p-4">
                ...
                <div class="flex items-center justify-end gap-6 mt-2">
                    <?php $subtotal = $total + $cart['freight_cost']; ?>
...
<div class="flex justify-center gap-4 mt-6">
    ...
    <button type="submit" name="ProcessOrder" value="1" class="px-8 py-2.5 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white font-medium rounded-md hover:from-indigo-700 hover:to-indigo-800 transition shadow-sm"><i class="fas fa-check mr-2"></i>Place Quotation</button>
</div>
</form>
<?php endif; ?>
<?php echo $__env->make('components.item-search-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lupu\Desktop\laravel\fa-saas\resources\views/sales/quotations/create.blade.php ENDPATH**/ ?>