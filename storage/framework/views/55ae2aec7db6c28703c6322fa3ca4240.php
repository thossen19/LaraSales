    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200" id="lineItemsTable">
            ...
            <tbody class="bg-white divide-y divide-gray-200" id="lineItemsBody">
                <?php $__empty_1 = true; $__currentLoopData = $quotation->lineItems ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $lineItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr id="lineItem_<?php echo e($index); ?>">
                        <td class="px-4 py-3">
                            <select name="line_items[<?php echo e($index); ?>][item_id]" class="w-full border border-gray-300 rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" onchange="updateLineItem(<?php echo e($index); ?>)">
                                <option value="">Select Item</option>
                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>" <?php echo e($lineItem->item_code == $item->code ? 'selected' : ''); ?> data-price="<?php echo e($item->sale_price); ?>" data-code="<?php echo e($item->code); ?>"><?php echo e($item->code); ?> - <?php echo e($item->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </td>
                        <td class="px-4 py-3">
                            <input type="text" name="line_items[<?php echo e($index); ?>][description]" value="<?php echo e($lineItem->description); ?>" class="w-full border border-gray-300 rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        </td>
                        <td class="px-4 py-3">
                            <input type="number" name="line_items[<?php echo e($index); ?>][quantity]" value="<?php echo e($lineItem->quantity); ?>" step="0.01" min="0" class="w-20 border border-gray-300 rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" onchange="calculateLineTotal(<?php echo e($index); ?>)">
                        </td>
                        <td class="px-4 py-3">
                            <input type="number" name="line_items[<?php echo e($index); ?>][unit_price]" value="<?php echo e($lineItem->unit_price); ?>" step="0.01" min="0" class="w-24 border border-gray-300 rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" onchange="calculateLineTotal(<?php echo e($index); ?>)">
                        </td>
                        <td class="px-4 py-3">
                            <input type="number" name="line_items[<?php echo e($index); ?>][tax_rate]" value="<?php echo e($lineItem->tax_rate); ?>" step="0.01" min="0" class="w-20 border border-gray-300 rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" onchange="calculateLineTotal(<?php echo e($index); ?>)">
                        </td>
                        <td class="px-4 py-3">
                            <input type="number" name="line_items[<?php echo e($index); ?>][discount_percentage]" value="<?php echo e($lineItem->discount_percentage); ?>" step="0.01" min="0" class="w-20 border border-gray-300 rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" onchange="calculateLineTotal(<?php echo e($index); ?>)">
                        </td>
                        <td class="px-4 py-3">
                            <input type="number" name="line_items[<?php echo e($index); ?>][line_total]" value="<?php echo e($lineItem->line_total); ?>" step="0.01" readonly class="w-24 border border-gray-300 rounded-md px-2 py-1 text-sm bg-gray-50">
                        </td>
                        <td class="px-4 py-3">
                            <button type="button" onclick="removeLineItem(<?php echo e($index); ?>)" class="text-red-600 hover:text-red-900">
                    ...
                    <tr id="lineItem_0">
                        <td class="px-4 py-3">
                            <select name="line_items[0][item_id]" class="w-full border border-gray-300 rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" onchange="updateLineItem(0)">
                                <option value="">Select Item</option>
                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>" data-price="<?php echo e($item->sale_price); ?>" data-code="<?php echo e($item->code); ?>"><?php echo e($item->code); ?> - <?php echo e($item->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </td>
                        <td class="px-4 py-3">
...
<input type="hidden" name="line_items_count" id="lineItemsCount" value="<?php echo e(max(1, ($quotation->lineItems ?? collect())->count())); ?>">

<script>
let lineItemCount = <?php echo e(max(1, ($quotation->lineItems ?? collect())->count())); ?>;
...
<?php /**PATH C:\Users\Lupu\Desktop\laravel\fa-saas\resources\views/sales/quotations/_line_items.blade.php ENDPATH**/ ?>