<?php $__env->startSection('title', 'Manage Document Categories'); ?>
...
<form method="POST" action="<?php echo e(route('hr.document-types')); ?>" class="bg-white shadow rounded-lg mb-6">
    <?php echo csrf_field(); ?>
    ...
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50 <?php echo e($t->inactive ? 'text-gray-400' : ''); ?>">
                <td class="px-4 py-2 text-sm"><?php echo e($t->type_id); ?></td>
                <td class="px-4 py-2 text-sm"><?php echo e($t->type_name); ?></td>
                <td class="px-4 py-2 text-sm"><?php echo e($t->notify_before); ?> days</td>
                <td class="px-4 py-2 text-sm text-center">
                    <button type="submit" name="toggle_inactive" value="<?php echo e($t->type_id); ?>"
                        class="inline-flex items-center px-2 py-1 rounded text-xs font-medium <?php echo e($t->inactive ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'); ?>">
                        <?php echo e($t->inactive ? 'Yes' : 'No'); ?>

                    </button>
                </td>
                <td class="px-4 py-2 text-sm text-center">
                    <button type="submit" name="Edit<?php echo e($t->type_id); ?>" value="1"
                        class="text-indigo-600 hover:text-indigo-900 mr-2">Edit</button>
                    <button type="submit" name="Delete<?php echo e($t->type_id); ?>" value="1"
...
<form method="POST" action="<?php echo e(route('hr.document-types')); ?>" class="bg-white shadow rounded-lg">
    <?php echo csrf_field(); ?>
    <?php if($selected_id): ?>
    ...
    <div class="p-6">
        <div class="mb-4">
            ...
            <input type="text" name="name" value="<?php echo e(old('name', $selected_type->type_name ?? '')); ?>" maxlength="50"
        ...
        <div class="mb-4">
            ...
            <div class="flex items-center gap-2">
                <input type="text" name="days" value="<?php echo e(old('days', $selected_type->notify_before ?? '')); ?>" maxlength="10"
    ...
    <div class="px-6 py-4 bg-gray-50 rounded-b-lg border-t border-gray-200">
        <?php if($selected_id): ?>
            ...
            <a href="<?php echo e(route('hr.document-types')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lupu\Desktop\laravel\fa-saas\resources\views/hr/document-types.blade.php ENDPATH**/ ?>