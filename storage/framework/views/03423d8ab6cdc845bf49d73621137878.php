<?php $__env->startSection('title', 'New Sales Order Entry - Sales ERP'); ?>
<?php $__env->startSection('content'); ?>
<div class="mb-8">
    <h2 class="text-2xl font-bold text-gray-900">New Sales Order Entry</h2>
</div>
...
<?php if($addedID): ?>
    <div class="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded mb-4 text-center">
        Order # <?php echo e($addedID); ?> has been entered.
    </div>
    <div class="text-center mb-4">
        <a href="<?php echo e(route('sales.orders.create', ['NewOrder' => 'Yes'])); ?>" class="text-indigo-600 hover:text-indigo-900 underline">Enter a New Order</a>
    </div>
<?php else: ?>

<form method="POST" action="<?php echo e(route('sales.orders.create')); ?>">
<?php echo csrf_field(); ?>
...
<div class="flex justify-center gap-4 mt-6">
    <button type="submit" name="CancelOrder" value="1" class="px-6 py-2.5 bg-white text-gray-700 font-medium rounded-md hover:bg-gray-100 transition border border-gray-300 shadow-sm"><i class="fas fa-times mr-2"></i>Cancel Order</button>
    <button type="submit" name="ProcessOrder" value="1" class="px-8 py-2.5 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white font-medium rounded-md hover:from-indigo-700 hover:to-indigo-800 transition shadow-sm"><i class="fas fa-check mr-2"></i>Place Order</button>
</div>
</form>
<?php endif; ?>
<?php echo $__env->make('components.item-search-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lupu\Desktop\laravel\fa-saas\resources\views/sales/orders/create.blade.php ENDPATH**/ ?>