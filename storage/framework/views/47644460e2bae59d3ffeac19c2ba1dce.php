...
<form method="POST" action="<?php echo e(route('hr.leave-types')); ?>" class="bg-white shadow rounded-lg mb-6">
    <?php echo csrf_field(); ?>
    ...
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50 <?php echo e($lt->inactive ? 'text-gray-400' : ''); ?>">
                <td class="px-4 py-2 text-sm"><?php echo e($lt->leave_id); ?></td>
                <td class="px-4 py-2 text-sm"><?php echo e($lt->leave_name); ?></td>
                <td class="px-4 py-2 text-sm"><?php echo e($lt->leave_code); ?></td>
                <td class="px-4 py-2 text-sm"><?php echo e(number_format($lt->pay_rate, 4)); ?>%</td>
                <td class="px-4 py-2 text-sm text-center">
                    <button type="submit" name="toggle_inactive" value="<?php echo e($lt->leave_id); ?>"
                        class="inline-flex items-center px-2 py-1 rounded text-xs font-medium <?php echo e($lt->inactive ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'); ?>">
                        <?php echo e($lt->inactive ? 'Yes' : 'No'); ?>

                    </button>
                </td>
                <td class="px-4 py-2 text-sm text-center">
                    <button type="submit" name="Edit<?php echo e($lt->leave_id); ?>" value="1"
                        class="text-indigo-600 hover:text-indigo-900 text-sm">Edit</button>
                </td>
                <td class="px-4 py-2 text-sm text-center">
                    <button type="submit" name="Delete<?php echo e($lt->leave_id); ?>" value="1"
...
<form method="POST" action="<?php echo e(route('hr.leave-types')); ?>" class="bg-white shadow rounded-lg">
    <?php echo csrf_field(); ?>
    ...
    <div class="p-6">
        <div class="mb-4">
            ...
            <div class="flex items-center gap-2">
                <input type="text" name="pay_rate" value="<?php echo e(old('pay_rate', $selected_leave_type->pay_rate ?? '')); ?>" maxlength="20" size="20"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="leave_name" value="<?php echo e(old('leave_name', $selected_leave_type->leave_name ?? '')); ?>" maxlength="30" size="30"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="leave_code" value="<?php echo e(old('leave_code', $selected_leave_type->leave_code ?? '')); ?>" maxlength="3" size="5"
    ...
    <div class="px-6 py-4 bg-gray-50 rounded-b-lg border-t border-gray-200">
        <?php if($selected_id !== -1): ?>
            ...
            <a href="<?php echo e(route('hr.leave-types')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lupu\Desktop\laravel\fa-saas\resources\views/hr/leave-types.blade.php ENDPATH**/ ?>