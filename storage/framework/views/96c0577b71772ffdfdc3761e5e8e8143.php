<?php $__env->startSection('title', 'Customer Credit Note Entry - Sales ERP'); ?>
...
<form method="POST" action="<?php echo e(route('sales.credit-notes.index')); ?>">
<?php echo csrf_field(); ?>
    ...
    <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-4">
            ...
            <div>
                ...
                <input type="date" name="credit_date" value="<?php echo e($cart['credit_date']); ?>" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition text-sm">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Reference</label>
                <input type="text" name="reference" value="<?php echo e($cart['reference']); ?>" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition text-sm" placeholder="Optional reference">
            </div>
            <div>
            ...
            <div>
                ...
                <select name="sales_order_id" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition text-sm">
                    ...
                    <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($inv->id); ?>" <?php echo e($cart['sales_order_id'] == $inv->id ? 'selected' : ''); ?>><?php echo e($inv->order_number); ?> - $<?php echo e(number_format($inv->total_amount, 2)); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div>
                ...
                <select name="reason" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition text-sm">
                    ...
                    <option value="Goods Return" <?php echo e($cart['reason'] == 'Goods Return' ? 'selected' : ''); ?>>Goods Return</option>
                    <option value="Damaged Goods" <?php echo e($cart['reason'] == 'Damaged Goods' ? 'selected' : ''); ?>>Damaged Goods</option>
                    <option value="Wrong Item Shipped" <?php echo e($cart['reason'] == 'Wrong Item Shipped' ? 'selected' : ''); ?>>Wrong Item Shipped</option>
                    <option value="Price Adjustment" <?php echo e($cart['reason'] == 'Price Adjustment' ? 'selected' : ''); ?>>Price Adjustment</option>
                    <option value="Discount" <?php echo e($cart['reason'] == 'Discount' ? 'selected' : ''); ?>>Discount</option>
                    <option value="Other" <?php echo e($cart['reason'] == 'Other' ? 'selected' : ''); ?>>Other</option>
                </select>
            </div>
        </div>
    </div>
...
<div class="bg-white shadow rounded-lg overflow-hidden mb-6">
    ...
    <div class="p-6">
            ...
            <div>
                ...
                <select name="stock_id" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition text-sm">
                    ...
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($it->code); ?>" <?php echo e($cart['stock_id'] == $it->code ? 'selected' : ''); ?>><?php echo e($it->code); ?> - <?php echo e($it->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">Description</label>
                <input type="text" name="item_description" value="<?php echo e($cart['item_description']); ?>" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition text-sm" placeholder="Description">
            </div>
            <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">Quantity</label>
                <input type="number" name="qty" value="<?php echo e($cart['qty']); ?>" step="0.01" min="0" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition text-sm">
            </div>
            <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">Unit Price</label>
                <input type="number" name="price" value="<?php echo e($cart['price']); ?>" step="0.01" min="0" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition text-sm">
            </div>
            <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">Discount %</label>
                <div class="flex gap-2">
                    <input type="number" name="discount" value="<?php echo e($cart['discount']); ?>" step="0.01" min="0" max="100" class="flex-1 border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition text-sm">
        ...
        <div class="overflow-x-auto border border-gray-200 rounded-lg">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $subtotal = 0; ?>
                    <?php $__empty_1 = true; $__currentLoopData = $cart['line_items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $li): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php $lineTotal = $li['quantity'] * $li['unit_price'] * (1 - $li['discount_percent']); $subtotal += $lineTotal; ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-sm text-right text-gray-700"><?php echo e(number_format($li['discount_percent'] * 100, 2)); ?>%</td>
                            <td class="px-4 py-3 text-sm text-right text-gray-900 font-medium"><?php echo e(number_format($lineTotal, 2)); ?></td>
                            <td class="px-4 py-3 text-center">
                                <button type="submit" name="DeleteItem" value="<?php echo e($idx); ?>" class="text-red-600 hover:text-red-900 p-1" title="Delete"><i class="fas fa-trash text-xs"></i></button>
                            </td>
                        </tr>
        ...
        <?php if(count($cart['line_items']) > 0): ?>
        <div class="flex justify-end mt-4">
            <div class="w-72 space-y-2">
                ...
                <div class="flex justify-between text-base font-bold pt-2 border-t border-gray-200">
                    ...
                    <span class="text-orange-700">$<?php echo e(number_format($subtotal, 2)); ?></span>
                </div>
            </div>
        </div>
        <?php endif; ?>
...
<div class="mb-6">
    ...
    <textarea name="memo" rows="3" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition"><?php echo e($cart['memo']); ?></textarea>
</div>
...
<div class="bg-white shadow rounded-lg overflow-hidden mt-8">
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $recentCredits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-4 py-3 text-sm font-medium text-gray-900"><?php echo e($cn->credit_note_number); ?></td>
                        <td class="px-4 py-3 text-sm text-gray-700"><?php echo e($cn->customer->name ?? 'N/A'); ?></td>
                        <td class="px-4 py-3 text-sm text-gray-700"><?php echo e($cn->credit_date ? $cn->credit_date->format('d/m/Y') : '-'); ?></td>
                        <td class="px-4 py-3 text-sm text-gray-600"><?php echo e($cn->reason ?? '-'); ?></td>
                        <td class="px-4 py-3 text-sm text-right text-gray-900 font-medium">$<?php echo e(number_format($cn->total_amount, 2)); ?></td>
                        <td class="px-4 py-3 text-center">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800"><?php echo e(ucfirst($cn->status)); ?></span>
                        </td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lupu\Desktop\laravel\fa-saas\resources\views/sales/credit-notes/index.blade.php ENDPATH**/ ?>