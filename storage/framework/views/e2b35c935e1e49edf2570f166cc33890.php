<?php $__env->startSection('title', 'Invoice Against Sales Delivery - Sales ERP'); ?>
...
<?php if($createFromId && $delivery): ?>
    
    <form method="POST" action="<?php echo e(route('sales.invoice.from-delivery')); ?>">
    <?php echo csrf_field(); ?>
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden mb-6">
        <div class="px-6 py-4 bg-gradient-to-r from-indigo-600 to-indigo-700 flex items-center justify-between">
            ...
            <div class="text-sm text-indigo-200">
                Delivery: <span class="font-semibold text-white"><?php echo e($delivery->order_number); ?></span> |
                Customer: <span class="font-semibold text-white"><?php echo e($delivery->customer->name ?? 'N/A'); ?></span>
            </div>
        </div>
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div>
                    ...
                    <input type="date" name="invoice_date" value="<?php echo e(date('Y-m-d')); ?>" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Reference</label>
                    <input type="text" value="<?php echo e($delivery->internal_notes ?? ''); ?>" readonly class="w-full border border-gray-200 bg-gray-50 rounded-md px-3 py-2 text-sm text-gray-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Sales Type</label>
                    <input type="text" value="<?php echo e($delivery->salesType->type_name ?? 'N/A'); ?>" readonly class="w-full border border-gray-200 bg-gray-50 rounded-md px-3 py-2 text-sm text-gray-500">
                </div>
            </div>
                ...
                <div class="overflow-x-auto border border-gray-200 rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $subtotal = 0; ?>
                            <?php $__currentLoopData = $delivery->lineItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $li): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $lineTotal = $li->quantity * $li->unit_price * (1 - ($li->discount_percentage / 100)); $subtotal += $lineTotal; ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-3 text-sm font-medium text-gray-900"><?php echo e($li->item_code); ?></td>
                                    <td class="px-4 py-3 text-sm text-gray-700"><?php echo e($li->description); ?></td>
                                    <td class="px-4 py-3 text-sm text-right text-gray-700"><?php echo e(number_format($li->quantity, 4)); ?></td>
                                    <td class="px-4 py-3 text-sm text-right text-gray-700"><?php echo e(number_format($li->unit_price, 4)); ?></td>
                                    <td class="px-4 py-3 text-sm text-right text-gray-700"><?php echo e(number_format($li->discount_percentage, 2)); ?>%</td>
                                    <td class="px-4 py-3 text-sm text-right text-gray-900 font-medium"><?php echo e(number_format($lineTotal, 4)); ?></td>
                                </tr>
                ...
                <div class="flex justify-end">
                    <div class="w-72 space-y-2">
                        ...
                        <div class="flex justify-between text-base font-bold pt-2 border-t border-gray-200">
                            ...
                            <span class="text-indigo-700">$<?php echo e(number_format($subtotal, 2)); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6">
                ...
                <textarea name="Comments" rows="3" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition"><?php echo e($delivery->customer_notes ?? ''); ?></textarea>
            </div>
        </div>
    </div>
...
<?php else: ?>
    ...
    <form method="GET" action="<?php echo e(route('sales.invoice.from-delivery')); ?>">
    <div class="bg-white shadow rounded-lg overflow-hidden mb-6">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                <div>
                    ...
                    <input type="text" name="delivery_no" value="<?php echo e($searchDeliveryNo); ?>" placeholder="Partial or full #" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition text-sm">
                </div>
                <div>
                    ...
                    <select name="customer_id" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition text-sm">
                        ...
                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($c->id); ?>" <?php echo e($searchCustomer == $c->id ? 'selected' : ''); ?>><?php echo e($c->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    ...
                    <select name="location" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition text-sm">
                        ...
                        <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($loc->loc_code); ?>" <?php echo e($searchLocation == $loc->loc_code ? 'selected' : ''); ?>><?php echo e($loc->location_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">From Date</label>
                    <input type="date" name="from_date" value="<?php echo e($searchFrom); ?>" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">To Date</label>
                    <input type="date" name="to_date" value="<?php echo e($searchTo); ?>" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition text-sm">
                </div>
            </div>
            <div class="mt-4 flex items-center gap-4 flex-wrap">
                ...
                <a href="<?php echo e(route('sales.invoice.from-delivery', ['outstanding_only' => 0])); ?>" class="px-5 py-2 bg-white text-gray-700 font-medium rounded-md hover:bg-gray-100 transition border border-gray-300 shadow-sm text-sm"><i class="fas fa-times mr-2"></i>Show All</a>
                <label class="inline-flex items-center gap-2 text-sm text-gray-700 cursor-pointer select-none">
                    ...
                    <input type="checkbox" name="outstanding_only" value="1" <?php echo e($outstandingOnly ? 'checked' : ''); ?> class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $deliveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-4 py-3 text-center">
                                <input type="checkbox" name="selected_deliveries[]" value="<?php echo e($d->id); ?>" class="delivery-checkbox rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" <?php echo e($d->status !== 'delivered' ? 'disabled' : ''); ?>>
                            </td>
                            <td class="px-4 py-3 text-sm font-medium text-gray-900"><?php echo e($d->order_number); ?></td>
                            <td class="px-4 py-3 text-sm text-gray-600"><?php echo e($d->internal_notes ?? '-'); ?></td>
                            <td class="px-4 py-3 text-sm text-gray-600"><?php echo e($d->customer_notes ?? '-'); ?></td>
                            <td class="px-4 py-3 text-sm text-gray-700"><?php echo e($d->customer->name ?? 'N/A'); ?></td>
                            <td class="px-4 py-3 text-sm text-gray-700"><?php echo e($d->delivery_date ? $d->delivery_date->format('d/m/Y') : '-'); ?></td>
                            <td class="px-4 py-3 text-sm text-gray-600"><?php echo e($d->location ?? '-'); ?></td>
                            <td class="px-4 py-3 text-sm text-right text-gray-700"><?php echo e($d->line_items_count); ?></td>
                            <td class="px-4 py-3 text-sm text-right text-gray-900 font-medium">$<?php echo e(number_format($d->total_amount, 2)); ?></td>
                            <td class="px-4 py-3 text-center whitespace-nowrap">
                                <div class="flex items-center justify-center gap-0.5">
                                    <a href="<?php echo e(route('sales.orders.edit', $d)); ?>" class="p-1.5 text-amber-600 hover:text-amber-900 hover:bg-amber-50 rounded transition" title="Edit"><i class="fas fa-edit text-xs"></i></a>
                                    <?php if($d->status === 'delivered'): ?>
                                        <form method="POST" action="<?php echo e(route('sales.invoice.from-delivery')); ?>" class="inline">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="select_invoice" value="<?php echo e($d->id); ?>">
                                    ...
                                    <?php endif; ?>
                                    <a href="<?php echo e(route('sales.orders.show', [$d, 'print' => 'delivery'])); ?>" title="Print" target="_blank" class="p-1.5 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded transition"><i class="fas fa-print text-xs"></i></a>
                                </div>
                            </td>
                        </tr>
        ...
        <?php if($deliveries->count() > 0): ?>
            <div class="px-6 py-3 bg-gray-50 border-t border-gray-200 flex items-center justify-between text-sm text-gray-500">
                <span>Showing <?php echo e($deliveries->count()); ?> delivery(s)</span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lupu\Desktop\laravel\fa-saas\resources\views/sales/invoice/from-delivery.blade.php ENDPATH**/ ?>